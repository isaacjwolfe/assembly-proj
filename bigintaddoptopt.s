...
//--------------------------------------------------------------------
        ...
        .equ BIGINT_ADD_STACK_BYTECOUNT, 80

        // Local variable offset
        LLENGTH2 .req x27      // variable to replace larger function
        LLENGTH1 .req x26      // variable to replace larger function
        LSUMLENGTH .req x25
        LINDEX .req x24
        ULSUM .req x23
        ULCARRY .req x22
...
add x0, x0, LLENGTH
ldr x0, [x0]
mov LLENGTH1, x0        // store length in variable
mov x1, OADDEND2
add x1, x1, LLENGTH
ldr x1, [x1]
mov LLENGTH2, x1          // store length in variable
